function Optimal_path = aStarFunc(MAP,xStart, yStart,xTarget,yTarget)
  ...
  for i=1:exp_count
    ...
    for j=1:OPEN_COUNT
        if(exp_array(i,1) == OPEN(j,2) && exp_array(i,2) == OPEN(j,3) )
            ...
            cost(OPEN(j,2),OPEN(j,3)) = OPEN(j,8);
...
if ( (xval == xTarget) && (yval == yTarget))
 ...
 % drawnow ;
 % end;
 plot(Optimal_path(:,2)+.5,Optimal_path(:,1)+.5);
 %contour(cost);
else
  pause(1);
